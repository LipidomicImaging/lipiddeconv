...
cqa1 V59 remains7/18 complete: D0 CAL/HOLD R1–R3 and D1 CAL_R1. D1 CAL_R2 finished training and is in serial rho, formal PID4983, rho-workers1, about100% of one CPU core and0% instantaneous GPU use. Supervisor PID2200 remains active. Seven completed case records had not previously been recovered; they are now downloaded and verified in results/v59_completed_snapshot_20260912 (91 compact source files, frozen design/oracle/sentinel/CAL provenance, cached process checks and per-case accounting). Large arrays/models remain on the source host with hashes; no cleanup or restart. D1/D2 final calibration/aggregation remains pending. Earlier operational entries below are historical and must not replace this observation.

# Storage retention update — 2026-09-11

User explicitly requested completed-result analysis, Git preservation, then deletion.50-case snapshot saved to Git4f6eda6 before230 redundant/intermediate ordinary checkpoints were removed. Exact retirements: results/v58_completed_snapshot_20260911/cleanup_plan.json and deletion_receipt.json. Final epoch3000 models, learned arrays, all records, all four compact sentinel-related cases, source draft sentinels and V57 controls remain. Historical runtime_storage_manifest.json may list retired intermediate checkpoints; consult the receipt rather than assuming every historical path still exists. Results and analysis source hashes are unchanged. Freed8.588GiB total; data free6.2GiB/root8.1GiB at04:32UTC. V5850/60 still running. No frozen scientific code changed.
